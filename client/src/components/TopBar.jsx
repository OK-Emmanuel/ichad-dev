const TopBar = () => {
    return (
      <div className="hidden md:block"> {/* Hide on mobile, show on medium screens and up */}
        <div className="bg-primary text-white text-sm py-3">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row md:justify-between md:items-center space-y-2 md:space-y-0">
              ...
              <button className="bg-secondary text-white px-6 py-2 rounded-full text-sm hover:bg-red-600 transition-colors w-fit text-base font-medium">
                Donate Now
              </button>
            </div>
          </div>
        ...
        {/* Move the dividing line outside of the previous div */}
